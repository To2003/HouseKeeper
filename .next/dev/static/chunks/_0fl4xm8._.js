...
function StoreProvider({ children, session }) {
    ...
    const [household, setHousehold] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [shopping, setShopping] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StoreProvider.useEffect": ()=>{
            ...
            async function loadData() {
                ...
                if (ms) setMembers(ms.map({
                    "StoreProvider.useEffect.loadData": (m)=>({
                            id: m.user_id,
                            name: m.name,
                            initials: m.initials,
                            color: m.color,
                ...
                }["StoreProvider.useEffect.loadData"]));
                if (ls) setLocations(ls.map({
                    "StoreProvider.useEffect.loadData": (l)=>({
                            id: l.id,
                            name: l.name,
                            icon: l.icon
                        })
                }["StoreProvider.useEffect.loadData"]));
                if (is) setInventory(is.map({
                    "StoreProvider.useEffect.loadData": (i)=>({
                            id: i.id,
                            name: i.name,
                ...
                if (ss) setShopping(ss.map({
                    "StoreProvider.useEffect.loadData": (s)=>({
                            id: s.id,
                            name: s.name,
                ...
                if (rs) setRecipes(rs.map({
                    "StoreProvider.useEffect.loadData": (r)=>({
                            id: r.id,
                            name: r.name,
                ...
                if (as) setActivity(as.map({
                    "StoreProvider.useEffect.loadData": (a)=>({
                            id: a.id,
        ...
        "StoreProvider.useMemo[value]": ()=>{
            ...
            return {
                        ...
                        if (data) {
                            setInventory({
                                "StoreProvider.useMemo[value]": (prev)=>prev.map({
                                        "StoreProvider.useMemo[value]": (i)=>i.id === data.id ? {
                                                ...i,
                                                name: data.name,
                        ...
                        if (data) {
                            setInventory({
                                "StoreProvider.useMemo[value]": (prev)=>[
                                        ...
                                        "StoreProvider.useMemo[value]": (a, b)=>a.name.localeCompare(b.name)
                                    }["StoreProvider.useMemo[value]"])
                            }["StoreProvider.useMemo[value]"]);
                ...
                async addShoppingItem (data) {
                    ...
                    }["StoreProvider.useMemo[value]"])) return;
                ...
                async toggleBought (id) {
                    const s = shopping.find({
                        "StoreProvider.useMemo[value].s": (i)=>i.id === id
                    }["StoreProvider.useMemo[value].s"]);
                    if (!s) return;
                ...
                async clearBought () {
                    const boughtIds = shopping.filter({
                        "StoreProvider.useMemo[value].boughtIds": (s)=>s.bought
                    }["StoreProvider.useMemo[value].boughtIds"]).map({
                        "StoreProvider.useMemo[value].boughtIds": (s)=>s.id
                    }["StoreProvider.useMemo[value].boughtIds"]);
                ...
                async addToInventoryFromShopping (data) {
                    ...
                    if (existing) {
                        ...
                        if (res) {
                            setInventory({
                                "StoreProvider.useMemo[value]": (prev)=>prev.map({
                                        "StoreProvider.useMemo[value]": (i)=>i.id === res.id ? {
                                                ...i,
                                                quantity: Number(res.quantity),
                ...
                async saveService (svc) {
                    ...
                    if (svc.id) {
                        ...
                        if (data) {
                            setServices({
                                "StoreProvider.useMemo[value]": (prev)=>prev.map({
                                        "StoreProvider.useMemo[value]": (s)=>s.id === data.id ? {
                                                ...s,
                                                ...data,
                        ...
                        if (data) {
                            setServices({
                                "StoreProvider.useMemo[value]": (prev)=>[
                                        ...
                                        "StoreProvider.useMemo[value]": (a, b)=>a.dueDate.localeCompare(b.dueDate)
                                    }["StoreProvider.useMemo[value]"])
                            }["StoreProvider.useMemo[value]"]);
                ...
                async toggleServiceStatus (id) {
                    const svc = services.find({
                        "StoreProvider.useMemo[value].svc": (s)=>s.id === id
                    }["StoreProvider.useMemo[value].svc"]);
                    if (!svc) return;
                ...
                async updateProfile (data) {
                    ...
                    if (!error) {
                        ...
                        setMembers({
                            "StoreProvider.useMemo[value]": (prev)=>prev.map({
                                    "StoreProvider.useMemo[value]": (m)=>m.id === currentUser.id ? {
                                            ...m,
                                            ...data
                                        } : m
                                }["StoreProvider.useMemo[value]"])
...
_s(StoreProvider, "eXTiH/ovDH9XDRcC1tSeJWCWtxE=");
_c = StoreProvider;
function useStore() {
    _s1();
...
function AuthFlow({ onDone, session }) {
    _s();
    const [stage, setStage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(session ? 'onboarding' : 'landing');
    const [authMode, setAuthMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('in');
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "mx-auto flex min-h-dvh w-full max-w-md flex-col bg-background",
        children: [
            stage === 'landing' && !session && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(HeroScreen, {
                onLogin: ()=>{
                    setAuthMode('in');
                    setStage('auth');
                },
            ...
            stage === 'auth' && !session && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(EmailAuthScreen, {
            ...
            stage === 'onboarding' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(OnboardingScreen, {
                onDone: onDone,
                session: session
            }, void 0, false, {
                fileName: "[project]/components/auth/auth-flow.tsx",
...
_s(AuthFlow, "01OairycMhyzaV4q1OBDKvyk3qM=");
_c = AuthFlow;
function Brand() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(EmailAuthScreen, "e98YvD9i5n2YBhNph1/MYGJisFA=");
_c4 = EmailAuthScreen;
...
__turbopack_context__.k.register(_c3, "HeroScreen");
__turbopack_context__.k.register(_c4, "EmailAuthScreen");
__turbopack_context__.k.register(_c5, "OnboardingScreen");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
                            ...
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$helpers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["timeAgo"])(a.timestamp)
                                    }, void 0, false, {
                                        fileName: "[project]/components/sections/dashboard.tsx",
                                        lineNumber: 97,
                                        columnNumber: 17
...
_s(ItemModal, "hg+Awj4Wo4L79F+4cJYeuGkpSr4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$store$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"]
    ];
});
...
"[project]/components/sections/perfil.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Perfil({ navigate }) {
    ...
    const [lastName, setLastName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(currentUser?.lastName || '');
    const [nickname, setNickname] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(currentUser?.nickname || '');
    const [birthDate, setBirthDate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(currentUser?.birthDate || '');
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$sections$2f$perfil$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/sections/perfil.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function AppShell() {
    ...
    const { members, household, shopping, services, currentUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$store$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStore"])();
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    tab === 'perfil' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$sections$2f$perfil$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Perfil"], {
                        navigate: setTab
                    }, void 0, false, {
                        fileName: "[project]/components/app-shell.tsx",
                        lineNumber: 62,
...
_s(AppShell, "64lmLRwDud8w8lN1Emugt/IAN+Q=", false, function() {
    return [
...
//# sourceMappingURL=_0fl4xm8._.js.map